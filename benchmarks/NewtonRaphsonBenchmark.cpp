...
static void calculateJointPositionsThreeDoFsSmallChange(benchmark::State &state) 
{
...
static void calculateJointPositionsThreeDoFsBigChange(benchmark::State &state) 
{
  std::string urdfPathName = package_path::getPath();
  urdfPathName += "/../install/multi_end_effector_kinematics/share/multi_end_effector_kinematics/models/meldog/meldog_no_base_link.urdf";
...
BENCHMARK(calculateJointPositionsThreeDoFsSmallChange);
BENCHMARK(calculateJointPositionsThreeDoFsBigChange);
