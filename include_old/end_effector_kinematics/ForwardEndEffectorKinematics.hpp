#ifndef __LRT_FORWARD_END_EFFECTOR_KINEMATICS__
#define __LRT_FORWARD_END_EFFECTOR_KINEMATICS__
...
#include <end_effector_kinematics/EndEffectorKinematicsInfo.hpp>
...
namespace end_effector_kinematics 
{
   ...
   * and caching.
   */
  class ForwardEndEffectorKinematics
  {
    public:

    /** Constructor
     * @param [in] pinocchioInterface: kinematic pinocchio interface.
    ...
    PinocchioForwardEndEffectorKinematicsCppAd(
        ...
        const EndEffectorKinematicsInfo info,
